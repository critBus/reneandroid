...
import com.rene.android.reneandroid.LibreriasExternas.sun.java2d.DefaultDisposerRecord;
import com.rene.android.reneandroid.LibreriasExternas.sun.java2d.DisposerRecord;
import com.rene.android.reneandroid.LibreriasExternas.sun.java2d.DisposerTarget;
import com.rene.android.reneandroid.LibreriasExternas.sun.misc.ThreadGroupUtils;
import com.rene.android.reneandroid.LibreriasExternas.sun.security.action.GetPropertyAction;
...
public class Disposer implements Runnable {
            ...
            try {
                ...
                try {
                    while((var0 = queue.poll()) != null && var1 < 10000 && var2 < 100) {
                        ...
                        if(var3 instanceof PollDisposable) {
                            var3.dispose();
                            var0 = null;
                            var3 = null;
                        } else if(var3 != null) {
    ...
    private static  void initIDs(){
        System.out.println("salida: parece que lo necesita *********************************");
    }
